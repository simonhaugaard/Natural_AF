...
Atrial_specific <- read.xlsx("../../01_dge/output/Overlap_analysis/Detected_Genes_Intersections.xlsx", 
...
setnames(Atrial_specific, old = c("Gene", "GENENAME"), new = c("ENSEMBL_ID", "GENENAME"))
...
gwas_hits_human <- c(
  "ANP", "TBX5", "MYL4", "MYOZ1", "PLEC", "PITX2", "TTN", "GATA4", "MYH6", "NKX2", "NKX3", 
  "NKX4", "NKX5", "CFL2", "MYH7", "PKP2", "RBM20", "SGCG", "SSPN", "ZFHX3", "KCCN3", "CEP68", 
